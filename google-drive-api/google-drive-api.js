export default {
  async fetch(request, env, ctx) {
    ...
    const CLIENT_ID = env.REACT_APP_GOOGLE_OAUTH_CLIENT_ID;
    const CLIENT_SECRET = env.REACT_APP_GOOGLE_OAUTH_CLIENT_SECRET;
    ...
    return new Response(JSON.stringify({
      ...
      path: path,
      availableRoutes: ['/getAuthUrl', '/getTokens', '/uploadToDrive', '/status', '/ping']
    }), { 
      status: 404,
      headers: {
        'Content-Type': 'application/json',
